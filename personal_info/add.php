    ...
    <div class="container py-5">
        <div class="card border-0 shadow-lg rounded-4 mx-auto" style="max-width: 1100px;">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="text-left text-danger mb-4">
                ...
                <div class="alert alert-danger alert-dismissible fade show rounded-3 mb-4" role="alert">
                    <strong>Duplicate Record Detected!</strong> A person with the same First Name, Last Name, and Date of Birth already exists (either confirmed or pending approval). Please verify the information before submitting.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                <?php endif; ?>

                
<form method="POST" action="add.php" enctype="multipart/form-data" id="addForm">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row g-3">
                         ...
                         <div class="col-md-6">
                                <label class="form-label fw-semibold">IMG</label>
                                <input type="file" class="form-control rounded-3" name="per_img" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select rounded-3" name="Sex" required>
                ...
                <div class="text-left mt-4">
                    <a href="accept_list.php" class="fw-semibold text-decoration-none text-danger">
